...
import bannerImg from "assets/banner-image-1-2.jpg";
      ...
      <Container sx={styles.container}>
        <Grid sx={styles.grid}>
          <Box sx={styles.content}>
            <Heading as="h3">
              Bridging the gap between the producer and the final consumer
            </Heading>
            <Text as="p">
              Concerta was created in 2021 and is a pioneer in the approach of
              consulting agrobusiness
            </Text>
            ...
            {state === "Error" && <MyModal>{errorMsg}</MyModal>}
            {state === "Success" && (
