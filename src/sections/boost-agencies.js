          ...
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                <Heading as="h3">
                  Boost your business with Concerta
                </Heading>
                <Text as="p">
                Concerta was created in 2021 and is a pioneer in the approach of consulting in the agribusiness sector. Specifically, our approach follows the "Farm to Fork" strategy with three dimensions: technical support, project management and corporate finances, both nationaly and aiming at building international relatioships of cooperation.
                </Text>
              </Box>
